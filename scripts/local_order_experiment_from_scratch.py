...
def experiment(delta):
    ...
    def local_step(key_OP):
        ...
        X_DELTA_EKF0_PARABOLAS = wrapped(None, init_x0, vector_field, delta)
        ...
        return X_DELTA_EKF0_PARABOLAS, X_DELTA_FINE_CLOSED_FORMULA
...
for delta in deltas:
    jnp.save(f'experiment_{delta}', experiment(delta))
