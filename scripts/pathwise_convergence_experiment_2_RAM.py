...
def experiment(delta, N, M, fine):
    ...
    def sde_solver(
        ...
        def body(x, inp):
            ...
            _, euler_path = euler_maruyama_pathwise(standard_incs, init=x2, drift=drift_shifted_ito, sigma=sigma_shifted_ito,
                                                    h=dt, N=fine)
        ...
        _, samples = jax.lax.scan(body, (init, x0), inps)
        traj, traj2 = samples
